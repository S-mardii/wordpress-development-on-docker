...
function mardiio_load_admin_scripts( $hook ) {
	...
	wp_register_style( 'mardiio_admin_style', get_template_directory_uri() . '/public/css/mardiio.admin.sidebar.css', [], '1.0.0', 'all' );
	wp_enqueue_style( 'mardiio_admin_style' );

	wp_enqueue_media();

	wp_register_script( 'mardiio_admin_script', get_template_directory_uri() . '/public/js/mardiio.admin.sidebar.js', ['jquery'], '1.0.0', true );
